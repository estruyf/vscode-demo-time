...
export default function APISettings({ settings, updateSetting }: APISettingsProps) {
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-demo-time-gray-7 mb-2">API Settings</h2>
        <p className="text-gray-600 dark:text-demo-time-gray-5 mb-6">Configure external API access</p>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>Enable API</Label>
              <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Allow external control of Demo Time</p>
            </div>
            <Switch
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Port number for the API server</p>
          </div>
        </div>
      </div>
    </Card>
