...
export default function HighlightingSettings({ settings, updateSetting }: HighlightingSettingsProps) {
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-demo-time-gray-7 mb-2">Highlighting Settings</h2>
        <p className="text-gray-600 dark:text-demo-time-gray-5 mb-6">Configure code highlighting appearance</p>
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Blur effect on non-highlighted text</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Opacity of non-highlighted text</p>
            </div>
          </div>
