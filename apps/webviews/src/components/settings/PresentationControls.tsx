  ...
  return (
    <Card>
      <div className="p-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">Basic presentation and demo controls</p>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>Enable Previous Command</Label>
              <p className="text-sm text-gray-600 dark:text-gray-300">Enable the previous command when in presentation mode</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Show a clock in the status bar</p>
            </div>
            <Switch
