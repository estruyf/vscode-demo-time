...
export default function PresentationControls({ settings, updateSetting }: PresentationControlsProps) {
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-demo-time-white mb-2">Presentation Controls</h2>
        <p className="text-demo-time-gray-4 mb-6">Basic presentation and demo controls</p>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>Enable Previous Command</Label>
              <p className="text-sm text-demo-time-gray-4">Enable the previous command when in presentation mode</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-demo-time-gray-4">Show a clock in the status bar</p>
            </div>
            <Switch
