...
export default function TemplatesSettings({ settings, updateSetting }: TemplatesSettingsProps) {
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-demo-time-gray-7 mb-2">Slide Templates</h2>
        <p className="text-gray-600 dark:text-demo-time-gray-5 mb-6">HTML templates for slide headers and footers (supports Handlebars syntax)</p>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={3}
            />
            <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">HTML template for slide headers with Handlebars variables</p>
          </div>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={3}
            />
            <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">HTML template for slide footers with Handlebars variables</p>
          </div>
        </div>
      </div>
    </Card>
