...
export default function TypingAnimationSettings({ settings, updateSetting }: TypingAnimationSettingsProps) {
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-demo-time-white mb-2">Typing Animation</h2>
        <p className="text-demo-time-gray-4 mb-6">Configure how content is inserted during demos</p>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-demo-time-gray-4">Mode for inserting content during demos</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-demo-time-gray-4">Characters per second for character-by-character mode</p>
            </div>
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-demo-time-gray-4">Characters per keystroke in hacker-typer mode</p>
            </div>
          </div>
        </div>
      </div>
