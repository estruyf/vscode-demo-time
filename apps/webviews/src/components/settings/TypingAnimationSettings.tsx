...
export default function TypingAnimationSettings({ settings, updateSetting }: TypingAnimationSettingsProps) {
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-demo-time-gray-7 mb-2">Typing Animation</h2>
        <p className="text-gray-600 dark:text-demo-time-gray-5 mb-6">Configure how content is inserted during demos</p>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Mode for inserting content during demos</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Characters per second for character-by-character mode</p>
            </div>
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Characters per keystroke in hacker-typer mode</p>
            </div>
          </div>
        </div>
      </div>
