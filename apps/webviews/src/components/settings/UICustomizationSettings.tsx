...
export default function UICustomizationSettings({ settings, updateSetting }: UICustomizationSettingsProps) {
  ...
  return (
    <Card>
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-demo-time-gray-7 mb-2">UI & Customization</h2>
        <p className="text-gray-600 dark:text-demo-time-gray-5 mb-6">Customize the interface and add custom components</p>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Path to a CSS file for custom theming</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600 dark:text-demo-time-gray-5">Paths to JavaScript files for custom web components</p>
          </div>
        </div>
      </div>
    </Card>
