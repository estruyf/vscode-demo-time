      ...
      {showInfo && (
        <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
          <p className="text-xs text-green-700 dark:text-green-300">
            <span className="font-medium text-green-800 dark:text-green-200">About Moves:</span> A move defines an action that you want to perform for your demo. Each demo can have multiple moves.
