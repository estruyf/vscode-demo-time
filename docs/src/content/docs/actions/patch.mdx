...
2. Follow the prompts to give your snapshot a name, and if you want to add it to a new/existing demo.
  ...
  <Aside>
  If you choose to add it as a new demo. In you act file, there should be a demo with the `create` and `open` actions.
  </Aside>
...
5. Follow the prompts to give your patch a name, and if you want to add it to a new/existing demo.
  ...
  <Aside>
  If you choose to add it as a new demo. In you act file, there should be a demo with the `applyPatch` and `open` actions.
  </Aside>
