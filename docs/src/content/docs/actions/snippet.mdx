...
Snippets can be used when you have steps that you want to reuse in multiple demos. You can define a snippet in the `.demo` folder and reference it in your act files.
