...
3. In the link field, enter the following URI:
   ...
   ```
4. Replace `<scene id>` with the actual ID of your demo

### Step 3: Find your scene ID

To get the scene ID for your link:

1. Open your act file in VS Code
2. Look for the `id` property in your demo configuration
3. If you don't have an ID set, add one to your act file:
