...
Looking for community snippets? Check the [Snippet Gallery](./gallery) page.
...
- action: highlight
  ...
  position: "{HIGHLIGHT_POSITION}"`} 
  lang="yaml" 
  title={`./snippets/insert_and_highlight.yaml`} />
</TabItem>
</Tabs>
